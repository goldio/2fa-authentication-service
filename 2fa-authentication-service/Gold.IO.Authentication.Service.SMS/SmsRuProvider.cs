...
namespace Gold.IO.Authentication.Service.SMS
{
    ...
    public class SmsRuProvider : ISmsProvider
    {
        ...
        String login = "89063266745";                                                               // Логин для доступа к SMS.RU
        String password = "ilnaz123";                                                                // Пароль для доступа к SMS.RU 
        String apiId = "83D1381B-2A0F-966D-7583-F4839258B022";                                      // Является вашим секретным кодом, который используется во внешних программах 
        ...
        String SmsRuEmail = "83D1381B-2A0F-966D-7583-F4839258B022" + "@sms.ru";                     // Ваш уникальный адрес (для отправки СМС по email)
        String email = "goldentime.service.personal@gmail.com";                                     // Ваш email адрес для отправки
        ...
        String dir = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs";
        String log_sent = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Sent.txt";
        String log_status = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Status.txt";
        String log_cost = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Cost.txt";
        String log_balance = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Balance.txt";
        String log_limit = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Limit.txt";
        String log_senders = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Senders.txt";
        String log_auth = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "AuthCheck.txt";
        String log_error = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Error.txt";
        String log_stoplist = "C:\\Users\\Администратор.WIN-QVBBKNJHDMA\\Documents\\GitHub\\GTExchange\\SmsRu\\Logs" + "Stoplist.txt";
        #endregion
